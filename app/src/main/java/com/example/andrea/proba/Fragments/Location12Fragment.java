...
public class Location12Fragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        malaLinkOff = getResources().getString(R.string.loc12_malaTabla_link_offline);
        golemaLinkOff = getResources().getString(R.string.loc12_golemaTabla_link_offline);
        if(connA)
        {
            web2.setHorizontalScrollBarEnabled(true);
            web2.loadUrl("http://stklimentpath.fikt.edu.mk/golemi/sv-jovan-kaneo.html");
            web2.requestFocus();
        }
        else
        {
