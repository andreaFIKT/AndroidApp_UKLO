...
public class Location14Fragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        malaLinkOff = getResources().getString(R.string.loc14_malaTabla_link_offline);
        golemaLinkOff = getResources().getString(R.string.loc14_golemaTabla_link_offline);
        if(connA)
        {
            web2.setHorizontalScrollBarEnabled(true);
            web2.loadUrl("http://stklimentpath.fikt.edu.mk/golemi/sv-bogorodica-s-velestovo.html");
            web2.requestFocus();
        }
        else
        {
