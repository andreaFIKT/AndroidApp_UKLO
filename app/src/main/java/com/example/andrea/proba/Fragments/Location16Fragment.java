 ...
 */
public class Location16Fragment extends android.support.v4.app.Fragment {
    WebView web2;
    Button buttonMore;
    Button buttonLess;
    boolean connA;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(connA)
        {
            ...
            web2.loadUrl("http://stklimentpath.fikt.edu.mk/golemi/bogorodica-zaumska.html");
            web2.requestFocus();
        }
        else
        {
...
//        buttonMore.setVisibility(View.VISIBLE);
        buttonLess = (Button)v.findViewById(R.id.btnLessLoc16);
